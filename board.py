...
class LudoBoard:
    ...
    def __init__(self, master):
        ...
        self.frame = tk.Frame(master, width=Board.PANEL_WIDTH, height=Board.PANEL_HEIGHT, bg="#4EB1BA")
        self.Quit = tk.Button(master, text='QUIT', command=master.quit, relief=tk.RAISED, width=20, height=2)
        self.title_bar = tk.Label(master, text=Text.HEADER, fg=Color.DEFAULT, bg="#4EB1BA", font=(None, 40), relief=tk.RAISED)
