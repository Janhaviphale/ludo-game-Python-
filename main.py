...
class Dice:
    ...
    def rolling(cls):
        ...
        image_label = tk.Label(ludo.get_frame(), width=100, height=100, image=img, bg="#00FFFF")  # Hex color code for cyan
    ...
    def set(cls, flag):
        ...
        if colors[cls.chance][0].is_player_won():
            ...
            image_label = tk.Label(ludo.get_frame(), width=100, height=100, image=img, bg="#4EB1BA")  # Hex color for cyan
...
# Append aligned colors with paths
